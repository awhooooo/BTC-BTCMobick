...
class MobickRPCsocket:
    ...
    def connect(self, blocking: bool = True) -> None:
        ...
        self.socket.setblocking(blocking)  # Set to non-blocking mode
...
async def main():
    ...
    rpc = MobickRPCsocket(host="220.85.71.15", port=40008) # or (host="13.55.48.220", port=40008)
    rpc.connect()
    print("connected")
    print(deserialize_header(await rpc.block_header(height=111194, cp_height=0)))
    print(deserialize_header((await rpc.block_headers(start_height=111194, count=10, cp_height=0))['hex']))
